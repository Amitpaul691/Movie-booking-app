...
const Admin = () => {
  ...
  const updateTempTheaterDetails = (e) => {
    if (e.target.name === "name") tempTheaterDetails.name = e.target.value;
                ...
                <div>
                  <div className="input-group mb-3">
                    ...
                    <input
                      type="text"
                      name="name"
                      value={tempTheaterDetails.name}
                      placeholder="Theater Name"
                      onChange={updateTempTheaterDetails}
                    />
                  </div>
                  ...
                  <div className="input-group my-2">
                    ...
                    <textarea
                      type="text"
                      name="description"
                      value={tempTheaterDetails.description}
                  ...
                  <div className="input-group mb-3">
                    ...
                    <input
                      type="text"
                      name="pinCode"
                      value={tempTheaterDetails.pinCode}
                      placeholder="Theater Pincode"
                      onChange={updateTempTheaterDetails}
                    />
                  </div>
